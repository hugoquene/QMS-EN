...
From the top bar, choose `Descriptives`. Select the variable(s) to summarize and place them into the field "Variables". Open the "Plots" field and check the option `Distribution plots` (under the heading "Basic plots") to obtain a histogram or bar chart (depending on the measurement level). 
...
From the top bar, choose `Descriptives`. Select the variable(s) to summarize and place them into the field "Variables". Open the "Statistics" field and check the option `Quartiles` (under the heading "Percentile values") to obtain quartiles. 
