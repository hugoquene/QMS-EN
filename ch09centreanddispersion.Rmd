...
new variable, called here `zReading` (note the parentheses in the first line):
```{r cito-zscores}
zReading <- (cito$Lezen-mean(cito$Lezen)) / sd(cito$Lezen) # standardized (z) reading scores
