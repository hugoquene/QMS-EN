...
```
If the `Distributions` option is not shown in the top bar, then you can add the option by clicking on the blue **+**-button in the top right corner, and checking option `Distributions`. \
...
which is at least three standard variations above the average (this is typically reported as $p<.001$). 
...
plot( 1:nsim, 1:nsim, type="n", 
	xlab="Speech tempo (second/syllable)", ylab="", xlim=c(0.195,0.245), yaxt="n" )
abline( v=0, lty=2 )
...
mtext("Speech tempo (second/syllable)", side=1, line=2)
mtext("Speech tempo (syllable/second)", side=3, line=2)
