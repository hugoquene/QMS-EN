...
The table titled **Model Summary** reports the correlation coefficient, here reported with capital $R=.749$.\
...
The table titled **Residual Statistics** provides information about the predicted values and residuals. Inspect whether the mean of the residuals is approximately zero (it should be). We also see here (row 2, column 4) that the standard deviation of the residuals is $3.212$.
