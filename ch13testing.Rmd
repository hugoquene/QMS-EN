...
accuracy, in this example as $p<.001$ [@Wright09, p.125].
...
From formula (\@ref(eq:t-onesampleCI)) below, it follows sensibly that if the sample standard deviation $s$ decreases, and/or if the sample size $N$ increases, then the confidence interval becomes smaller, i.e., the sample mean becomes a more trustworthy estimate of the population mean. 
