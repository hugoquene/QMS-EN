...
indicate the desired contrasts for the factor `kleur` (the Dutch variable name for colour of the group). 
However, the method
...
Note that the predictor is named `kleur` which is the Dutch term for colour of the group).
