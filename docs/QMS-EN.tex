...
\author{true}
\date{Version compiled 27 Aug 2024}
...
The modal income (per household) was between €22,000 and €24,000\footnote{\url{https://www.cbs.nl/nl-nl/visualisaties/inkomensverdeling}}: this income category contained the largest number of households.
\end{quote}
