...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dobbel.chi2.htest}\OperatorTok{$}\NormalTok{residuals }\CommentTok{\# raw residuals}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{sum}\NormalTok{( (dobbel.chi2.htest}\OperatorTok{$}\NormalTok{residuals)}\OperatorTok{\^{}}\DecValTok{2}\NormalTok{ ) }\CommentTok{\# chi2 = sum of sq of raw resid}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dobbel.chi2.htest}\OperatorTok{$}\NormalTok{stdres }\CommentTok{\# standardized residuals}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Titanic.chisq.htest}\OperatorTok{$}\NormalTok{stdres }\CommentTok{\# standardized residuals}
\end{Highlighting}
\end{Shaded}
