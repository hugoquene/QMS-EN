...
\author{true}
\date{Version compiled 15 Jul 2021}
...
\midrule
\endhead
(i) Regio & 3 & 0.0124 & 0.0041 & 6.09 & \textless.001 \\
(ii) Sex & 1 & 0.0102 & 0.0102 & 15.03 & \textless.001 \\
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{require}\NormalTok{(hqmisc) }\CommentTok{\# for hqmisc::talkers data set}
\FunctionTok{data}\NormalTok{(talkers)}
\NormalTok{ok }\OtherTok{\textless{}{-}}\NormalTok{ talkers}\SpecialCharTok{$}\NormalTok{syldur}\SpecialCharTok{\textless{}}\FloatTok{0.4} \CommentTok{\# TRUE for 79 of 80 talkers}
\CommentTok{\# table of means, see Table 15.2 in main text}
\FunctionTok{with}\NormalTok{(talkers, }\FunctionTok{tapply}\NormalTok{( syldur[ok], }\FunctionTok{list}\NormalTok{(region[ok],sex[ok]), mean ))}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{summary}\NormalTok{( }\FunctionTok{aov}\NormalTok{(syldur}\SpecialCharTok{\textasciitilde{}}\NormalTok{region}\SpecialCharTok{*}\NormalTok{sex, }\AttributeTok{data=}\NormalTok{talkers, }\AttributeTok{subset=}\NormalTok{ok) }\OtherTok{{-}\textgreater{}}\NormalTok{ m03 )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{omegasq}\NormalTok{(m03, }\StringTok{"region"}\NormalTok{)      }\CommentTok{\# [1] 0.1380875}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{omegasq}\NormalTok{(m03, }\StringTok{"sex"}\NormalTok{)         }\CommentTok{\# [1] 0.1291232}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{omegasq}\NormalTok{(m03, }\StringTok{"region:sex"}\NormalTok{)  }\CommentTok{\# [1] 0.01112131}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{TukeyHSD}\NormalTok{(}\AttributeTok{x=}\NormalTok{m03, }\AttributeTok{which=}\StringTok{"region"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
