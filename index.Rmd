...
The original Dutch version of this text was written in LaTeX, and was then converted to Rmarkdown, using `pandoc` [@pandoc] and the `bookdown` [@R-bookdown] in [Rstudio](https://www.rstudio.com). The Dutch version is available at https://hugoquene.github.io/KMS-NL/ . \
